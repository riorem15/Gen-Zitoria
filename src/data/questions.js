...
export const questionBank = [
  ...
  // LEVEL 1 (C1 & C2)
  {
    ...
    options: ["A. Sejarah", "B. Praaksara", "C. Prasejarah", "D. Megalitikum"],
    correctAnswer: "B. Praaksara",
  ...
  // LEVEL 2 (C3 & C4)
  {
    ...
    options: ["A. Bercocok tanam", "B. Perundagian", "C. Berburu dan meramu", "D. Megalitikum"],
    correctAnswer: "C. Berburu dan meramu",
  ...
  // LEVEL 3 (C5 & C6)
  {
    ...
    options: [
      "A. Keduanya mengakhiri sistem barter dan menggantinya dengan uang logam",
      "B. Keduanya memicu perubahan radikal dalam cara produksi makanan/barang",
      "C. Keduanya disebabkan oleh peperangan antar benua",
      "D. Keduanya melahirkan sistem tulisan yang universal"
    ],
    correctAnswer: "B. Keduanya memicu perubahan radikal dalam cara produksi makanan/barang",
  ...
  // LEVEL 1
  {
    ...
    options: ["A. Mesir Kuno", "B. Lembah Indus", "C. Mesopotamia", "D. Romawi Kuno"],
    correctAnswer: "C. Mesopotamia",
  ...
  // LEVEL 3
  {
    ...
    options: [
      "A. Kekuatan militer yang besar tidak berguna tanpa penemuan senjata api",
      "B. Korupsi internal, perpecahan politik, dan krisis ekonomi lebih mematikan daripada serangan militer murni dari luar",
      "C. Membangun tembok pertahanan yang panjang adalah satu-satunya cara bertahan",
      "D. Terlalu banyak fokus pada seni membuat sebuah negara menjadi lemah"
    ],
    correctAnswer: "B. Korupsi internal, perpecahan politik, dan krisis ekonomi lebih mematikan daripada serangan militer murni dari luar",
  ...
  },
  {
    ...
    options: [
      "A. Eropa berhasil menguasai seluruh cadangan minyak bumi",
      "B. Sistem pertanian berpindah ke metode hidroponik",
      "C. Terbukanya kembali jalur perdagangan produk Timur (seperti rempah dan sutra) ke Eropa",
      "D. Eropa berhenti menggunakan uang logam"
    ],
    correctAnswer: "C. Terbukanya kembali jalur perdagangan produk Timur (seperti rempah dan sutra) ke Eropa",
  ...
  // ======================== MODERN AWAL ========================
  {
    ...
    options: ["A. Reformasi Gereja", "B. Revolusi Industri", "C. Renaissance", "D. Pencerahan (Aufklarung)"],
    correctAnswer: "C. Renaissance",
  ...
  // ======================== MODERN & KONTEMPORER ========================
  {
    ...
    options: ["A. Revolusi Agraria", "B. Revolusi Industri", "C. Revolusi Prancis", "D. Revolusi Digital"],
    correctAnswer: "B. Revolusi Industri",
